	...
	if SKILL_INDEX_DICT.has_key(job):
		if SKILL_INDEX_DICT[job].has_key(group):
			...
			for i in xrange(len(activeSkillList)):
				...
				## 7쐻猷욎굲 8쐻猷욎굲 쐻猷욎굲沅쀫쐻猷욎굲 쐻猷욎굲쐻쑆苑 쐻猷욎굲쐻猷욎굲쐻뼣筌뤿슣굲 쐻뼍踰앹굲
				if i != 6 and i != 7:
...
def __InitData():
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_LEVELUP_ON_14_FOR_GERMANY, "","season1/effect/paymessage_warning.mse")	#쐻猷욎굲쐻猷욎굲쐻猷욎굲 14쐻뼣뵛굲 ( 쐻猷욎굲쐻猷욎굲쐻猷욎굲쐻猷욎굲 )
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_LEVELUP_UNDER_15_FOR_GERMANY, "", "season1/effect/paymessage_decide.mse" )#쐻猷욎굲쐻猷욎굲쐻猷욎굲 15쐻뼣뵛굲 ( 쐻猷욎굲쐻猷욎굲쐻猷욎굲쐻猷욎굲 )
...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+3, "Bip01", "d:/ymir work/effect/hit/blow_poison/poison_loop.mse") ## 쐻솯踰앹굲
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+16, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse") ## 筌ｌ뭿쐻猷욎굲쐻猷욎굲 (쐻솋뒻굲쐻猷욎굲 쐻솂踰앹굲-_-)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+17, "", "d:/ymir work/pc/assassin/effect/gyeonggong_loop.mse") ## 쐻솓ⓦ끉굲 - 쐻猷욎굲쐻
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+19, "Bip01 R Finger2", "d:/ymir work/pc/sura/effect/gwigeom_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+20, "", "d:/ymir work/pc/sura/effect/fear_loop.mse") ## 쐻猷욎굲쐻猷욎굲 - 쐻猷욎굲쐻猷욎굲
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+21, "", "d:/ymir work/pc/sura/effect/jumagap_loop.mse") ## 쐻猷욎굲쐻猷욎굲 - 쐻솂筌뤿슣굲쐻猷욎굲
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+22, "", "d:/ymir work/pc/shaman/effect/3hosin_loop.mse") ## 쐻猷욎굲쐻猷욎굲 - 깈쐻猷욎굲
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+23, "", "d:/ymir work/pc/shaman/effect/boho_loop.mse") ## 쐻猷욎굲쐻猷욎굲 - 쐻猷욎굲깈
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+24, "", "d:/ymir work/pc/shaman/effect/10kwaesok_loop.mse") ## 쐻猷욎굲쐻猷욎굲 - 쐻猷욎굲쐻
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+33, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse") ## 筌ｌ뭿쐻猷욎굲쐻猷욎굲 (Fallen)
	## 34 Polymoph
	...
	## FlyData
	effect.RegisterIndexedFlyData(effect.FLY_EXP, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_yellow_small2.msf")				## 쐻猷욎굲쐻猷욎굲쐻 (EXP)
	effect.RegisterIndexedFlyData(effect.FLY_HP_MEDIUM, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_red_small.msf")			## 쐻猷욎굲쐻猷욎굲쐻猷욎굲 (HP) 쐻猷욎굲쐻猷욎굲쐻猷욎굲
	effect.RegisterIndexedFlyData(effect.FLY_HP_BIG, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_red_big.msf")				## 쐻猷욎굲쐻猷욎굲쐻猷욎굲 (HP) 寃숇쐻猷욎굲
	effect.RegisterIndexedFlyData(effect.FLY_SP_SMALL, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_blue_warrior_small.msf")	## 쐻뻼뵛굲쐻猷욎굲 쐻猷욎굲쐻猷욎굲쐻猷욎굲 쐻솂뮉ⓦ끉굲
	effect.RegisterIndexedFlyData(effect.FLY_SP_MEDIUM, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_blue_small.msf")			## 쐻뻼뵛굲쐻猷욎굲 쐻猷욎굲쐻猷욎굲쐻猷욎굲
	effect.RegisterIndexedFlyData(effect.FLY_SP_BIG, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_blue_big.msf")				## 쐻뻼뵛굲쐻猷욎굲 寃숇쐻猷욎굲
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK1, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_1.msf")		## 쐻猷욎굲쐻猷욎굲 1
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK2, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_2.msf")		## 쐻猷욎굲쐻猷욎굲 2
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK3, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_3.msf")		## 쐻猷욎굲쐻猷욎굲 3
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK4, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_4.msf")		## 쐻猷욎굲쐻猷욎굲 4
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK5, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_5.msf")		## 쐻猷욎굲쐻猷욎굲 5
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK6, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_6.msf")		## 쐻猷욎굲쐻猷욎굲 6
	effect.RegisterIndexedFlyData(effect.FLY_FIREWORK_XMAS, effect.INDEX_FLY_TYPE_FIRE_CRACKER, "d:/ymir work/effect/etc/firecracker/firecracker_xmas.msf")	## 쐻猷욎굲쐻猷욎굲 X-Mas
	effect.RegisterIndexedFlyData(effect.FLY_CHAIN_LIGHTNING, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/shaman/effect/pokroe.msf")						## 쐻猷욎굲쐻솓ⓦ끉굲
	effect.RegisterIndexedFlyData(effect.FLY_HP_SMALL, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_red_smallest.msf")			## 쐻猷욎굲쐻猷욎굲쐻猷욎굲 쐻뻿뒻굲 쐻猷욎굲쐻猷욎굲쐻猷욎굲
	effect.RegisterIndexedFlyData(effect.FLY_SKILL_MUYEONG, effect.INDEX_FLY_TYPE_AUTO_FIRE, "d:/ymir work/pc/sura/effect/muyeong_fly.msf")					## 쐻猷욎굲쐻猷욎굲쐻猷욎굲
	...
	net.RegisterEmoticonString("(쐻뼦꺋굲)")
	...
	net.RegisterEmoticonString("(쐻뼑닰굲)")
...
def __LoadGameShamanEx(race, path):
	...
	START_INDEX = 0
	#skill.SKILL_EFFECT_COUNT 쐻猷욎굲쐻猷욎굲//
	for i in (1, 2, 3):
		END_STRING = ""
		if i != 0: END_STRING = "_%d" % (i+1)
...
def LoadGuildBuildingList(filename):
	...
	for i in xrange(count):
		...
		## GuildSymbol 쐻猷욎굲 쐻뼣獄袁⑹굲 NPC 쐻猷욎굲쐻 쐻셾癒굲 쐻猷욎굲쐻猷욎굲遙λ쐻.
		import chrmgr
